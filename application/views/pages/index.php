		...
		<div class="row">
			<div class="col-sm-6 col-md-4 col-lg-4">
				<div class="box">
					<div class="option_container">
						...
						<a href="" class="option2"><i class="fa-brands fa-whatsapp"></i>
						Buy Now
						</a>
						</div>
					</div>
					<div class="img-box">
						<img src="<?= base_url() ?>layouts/pages/images/p1.png" alt="">
					</div>
					<div class="detail-box">
						<h5>
						Men's Shirt
			...
			<div class="col-sm-6 col-md-4 col-lg-4">
				<div class="box">
					...
					<div class="img-box">
						<img src="<?= base_url() ?>layouts/pages/images/p2.png" alt="">
					</div>
					<div class="detail-box">
						<h5>
						Men's Shirt
			...
			<div class="col-sm-6 col-md-4 col-lg-4">
				<div class="box">
					...
					<div class="img-box">
						<img src="<?= base_url() ?>layouts/pages/images/p3.png" alt="">
					</div>
					<div class="detail-box">
						<h5>
						Women's Dress
