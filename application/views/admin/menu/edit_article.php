	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card mb-4">
				...
				<div class="card-body">
                	<form action="<?= base_url('Admin/update_article') ?>" method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label for="exampleInputEmail1">Title</label>
							<input type="hidden" name="id" value="<?= $edit->id ?>">
							<input type="text" class="form-control" name="title" id="title" value="<?= $edit->title ?>" placeholder="Enter Title" onkeyup="createTextSlug()">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="topic_article" value="<?= $edit->topic_article ?>" placeholder="Enter Topic">
						...
						<div class="form-group">
							...
							<img class="mt-2 mb-3" height="200" width="200" src="<?= base_url('layouts/images/article/' . $edit->images) ?>" alt="old image" />
							<img id="blah" class="mt-2 mb-3 ml-3" height="200" width="200" src="#" alt="preview new image" />
						</div>
						<hr>
